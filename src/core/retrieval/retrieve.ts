...
const INTENTS: Intent[] = [
  { category: 'account_termination', question: /\b(?:ban(?:s|ned|ning)?|suspend\w*|terminat\w*|disabl\w*|(?:end|clos\w*|restrict\w*).{0,20}(?:account|access))\b/i, evidence: /\b(?:suspend\w*|terminat\w*|ban(?:s|ned|ning)?|disabl\w*|(?:end|clos\w*|restrict\w*).{0,20}(?:account|access))\b/i, terms: ['ban', 'suspend', 'termination', 'terminate', 'disable', 'account', 'access'] },
